...
// DownloadRequest is vendored from SpotiFLAC-Mobile go_backend/exports_download.go
// at the pinned upstream commit. The extension core depends on this shared
// request contract for quality/provider selection.
